...
The data in question is exam data for primary 3 students for the subjects: English, Maths and Science. In addition, the class and gender of each student is given.
...
ggplot(data=exam_data, 
  ...
  geom_vline(aes(xintercept=median(MATHS, na.rm=T)),
             ...
             annotate("text", x=68, y=40, label="Mean", angle=90, size=3, color="red") +
  ylim(0,45)
```
