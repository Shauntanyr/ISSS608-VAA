...
1. Revenue is a good place to start to explore anomalous behaviour: 
   ...
   a. Beneficial owners who are sole owners of multiple companies
   b. Companies with unreported revenue yet with many beneficial owners and company contacts - shows that the company is extensive, and should be reporting high revenue, yet the revenue is unaccounted for. 
   c. Companies which are owned by single individuals vs those owned by multiple owners - complete control vs having to get the consensus of multiple shareholders. 
:::
